        ...
        <>
            ...
            <section className='md:px-10 w-full mx-auto flex justify-center items-center h-full '>
                <div className="w-full md:w-[30rem]">
                    ...
                    <Formik
                        initialValues={{ first_name: "", last_name: "", email: '', password: '', comfirm_password: "", is_publisher: false }}
                        validate={values => {
                    ...
                    >
                        {({ isSubmitting }) => (
                            <Form className='bg-gray-300 px-4 py-2 w-full rounded-sm drop-shadow-md'>
                                ...
                                <div className="w-1/2 space-x-3 flex justify-start items-center">
                                    <label htmlFor="is_publisher" className='text-md w-ull font-semibold py-2 text-secondary w-full'>Are you a publisher</label>
                                    <ErrorMessage name="is_publisher" component="div" className='text-red-400' />
                                    <Field type="checkbox" name="is_publisher" className="py-2 border-0 outline-none rounded-md w-6 h-6" />
                                </div>
